...
ฑฑบPrograma  ณ DELR005  บAutor  ณCarlos R. Abreu     บ Data ณ  15/06/05   บฑฑ
...
ฑฑบDescricao ณ Relatorio de SEPU                                          บฑฑ
...
Local cDesc1       := "Este relatorio imprime a rela็ใo de SEPUs de acordo"
...
Aadd(_aPergunt,{cPerg ,"02","At้ o lote      ?","","","mv_ch2","C",06,0,0,"G","","mv_par02","","","","","","","","","","","","","","","","","","","","","","","","","",""})
Aadd(_aPergunt,{cPerg ,"03","Da loja         ?","","","mv_ch3","C",02,0,0,"G","","mv_par03","","","","","","","","","","","","","","","","","","","","","","","","","DLB",""})
Aadd(_aPergunt,{cPerg ,"04","At้ a loja      ?","","","mv_ch4","C",02,0,0,"G","","mv_par04","","","","","","","","","","","","","","","","","","","","","","","","","DLB",""})
AAdd(_aPergunt,{cPerg ,"05","Da Dt Inclusใo  ?","","","mv_ch5","D",08,0,0,"G","","mv_par05","","","","","","","","","","","","","","","","","","","","","","","","","",""})
AAdd(_aPergunt,{cPerg ,"06","At้ Dt.Inclusใo ?","","","mv_ch6","D",08,0,0,"G","","mv_par06","","","","","","","","","","","","","","","","","","","","","",""})
...
While !PA4TMP->(EOF())
	...
	//ณ Tratamento se houve filtro escolhido pelo usuario        ณ
...
@ nLin,000 PSay "TOTAL BONIFICAวรO :"
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Tratamento do parametro Status do SEPU  						  	  ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
if mv_par07 <> '1' //'TODOS'
