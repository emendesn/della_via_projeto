...
ฑฑบPrograma  ณ DxDevDin บAutor  ณ Paulo Benedet            บ Data ณ 06/08/08 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออออออออสออออออฯออออออออออนฑฑ
ฑฑบDescricao ณ Realizar a devolucao de produto / servicos                    บฑฑ
ฑฑฬออออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบParametrosณ Nao ha                                                        บฑฑ
ฑฑฬออออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบRetorno   ณ Nao ha                                                        บฑฑ
ฑฑฬออออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบAplicacao ณ Rotina executada pelo ponto de entrada LOJA020                บฑฑ
ฑฑฬออออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Della Via Pneus                                               บฑฑ
ฑฑศออออออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Project Function DxDevDin()
Local aArea    := GetArea()
Local aAreaSD2 := SD2->(GetArea())
Local aAreaSE1 := SE1->(GetArea())
Local aAreaSE5 := SE5->(GetArea())

Local npVlrItem  := aScan(aHeader, {|x| rTrim(x[2]) == "L2_VLRITEM"}) // posicao da coluna valor item
Local nTotLin    := 0 // numero de linha do acols
Local cParc      := "" // parcela da ncc
Local nOpc       := 0 // indica confirmacao da tela
Local nDevPrd    := 0 // valor dos produtos
Local nVlrSrv    := 0 // valor dos servicos
Local nDevSrv    := 0 // valor da devolucao de servico
Local nDevSrvDin := 0 // valor devolvido em R$ ref a servico
Local nDevPrdDin := 0 // valor devolvido em R$ ref a produto
Local oDlg
Local i

/*
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Verifica se existe servico no orcamento ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
dbSelectArea("SD2")
dbSetOrder(3) // D2_FILIAL+D2_DOC+D2_SERIE+D2_CLIENTE+D2_LOJA+D2_COD+D2_ITEM
dbSeek(xFilial("SD2") + SL1->L1_DOC + SL1->L1_SERIE)

While !EOF();
	.And. SD2->D2_FILIAL == xFilial("SD2");
	.And. SD2->D2_DOC    == SL1->L1_DOC;
	.And. SD2->D2_SERIE  == SL1->L1_SERIE
	
	If SD2->D2_TP <> "ME" // produtos
		nVlrSrv += SD2->D2_TOTAL
	EndIf
...
//ณ Soma valores dos produtos devolvidos ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
nTotLin := Len(aCols)
For i := 1 to nTotLin
	If !aTail(aCols[i])
		nDevPrd += aCols[i][npVlrItem]
	EndIf
Next i

If nDevPrd > 0
	If SL1->L1_DINHEIR > 0 .Or. SL1->L1_CHEQUES > 0
		While .T.
			nOpc := 0
			
			//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
			//ณ Pergunta ao usuario o valor da devolucao em dinheiro ณ
			//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
			Define msDialog oDlg Title "Aten็ใo - Devolu็ใo de Produto" from 178,181 to 294,415 Pixel
				@ 002,002 to 043,116 Label "Digite o valor a ser devolvido em dinheiro" Pixel of oDlg
				
				@ 016,039 msGet nDevPrdDin Size 060,009 Picture "@E 999,999.99" Valid nDevPrdDin >= 0 Pixel of oDlg
				@ 018,012 Say "Valor:" Size 015,008 Pixel of oDlg
				
				Define sButton from 045,088 Type 1 Enable of oDlg Action(nOpc := 1, oDlg:End())
			Activate msDialog oDlg Centered
			
			If nOpc > 0
				If nDevPrdDin > SL1->(L1_DINHEIR + L1_CHEQUES) .Or. nDevPrdDin > nDevPrd
					msgAlert("Valor a devolver nใo pode ser maior que o recebido!", "Aviso")
				ElseIf !LjVSaldo(nDevPrdDin, "R$") // verifica saldo em R$ no caixa
				Else
					Exit
				EndIf
			EndIf
...
If nVlrSrv > 0
	While .T.
		...
		//ณ Pergunta ao usuario se havera devolucao de servico ณ
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
		Define msDialog oDlg Title "Aten็ใo - Devolu็ใo de Servi็o" from 178,181 to 294,415 Pixel
			@ 002,002 to 043,116 Label "Digite o valor da devolu็ใo" Pixel of oDlg
			
			@ 016,039 msGet nDevSrv Size 060,009 Picture "@E 999,999.99" Valid nDevSrv >= 0 Pixel of oDlg
			@ 018,012 Say "Valor:" Size 015,008 Pixel of oDlg
	...
	If nDevSrv > 0 .And. (SL1->L1_DINHEIR > 0 .Or. SL1->L1_CHEQUES > 0)
		While .T.
			nOpc := 0
			...
			Define msDialog oDlg Title "Aten็ใo - Devolu็ใo de Servi็o" from 178,181 to 294,415 Pixel
				...
				@ 016,039 msGet nDevSrvDin Size 060,009 Picture "@E 999,999.99" Valid nDevSrvDin >= 0 Pixel of oDlg
				@ 018,012 Say "Valor:" Size 015,008 Pixel of oDlg
			...
			If nOpc > 0
				If nDevSrvDin > SL1->(L1_DINHEIR + L1_CHEQUES) .Or. nDevSrvDin > nDevSrv
					msgAlert("Valor a devolver nใo pode ser maior que o recebido!", "Aviso")
				Else
					Exit
				EndIf
...
/*
If nDevSrv > 0 // devolucao em servicos
	//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
	//ณ Gera NCC no valor dos servicos devolvidos ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	cParc := GeraNCC(nDevSrv)
	
	If nDevSrvDin > 0
		//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
		//ณ Faz a baixa da NCC no valor a ser devolvido em R$ ณ
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
		BaixaNCC(cParc, nDevSrvDin)
	EndIf
EndIf
*/
...
If nDevPrd > 0
	...
	//ณ Gera NCC no valor total dos produtos devolvidos ณ
	//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
	cParc := GeraNCC(nDevPrd)
	
	If nDevPrdDin > 0
		//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
		//ณ Faz a baixa da NCC no valor a ser devolvido em R$ ณ
		//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
		BaixaNCC(cParc, nDevPrdDin)
	EndIf
EndIf
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออออออออหออออออัออออออออออปฑฑ
ฑฑบPrograma  ณ GeraNCC  บAutor  ณ Paulo Benedet            บ Data ณ 06/08/08 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออออออออสออออออฯออออออออออนฑฑ
ฑฑบDescricao ณ Gerar a NCC da devolucao                                      บฑฑ
ฑฑฬออออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบParametrosณ nValor - Valor da NCC a ser gerada                            บฑฑ
ฑฑฬออออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบRetorno   ณ cParcela - Parcela da NCC gerada                              บฑฑ
ฑฑฬออออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบAplicacao ณ Rotina executada pelo DxDevDin                                บฑฑ
ฑฑฬออออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบUso       ณ Della Via Pneus                                               บฑฑ
ฑฑศออออออออออฯอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออผฑฑ
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Static Function GeraNCC(nValor, cParcela)
Local cChave   := "" // chave a pesquisar
Local cTipDoc  := "" // tipo de docto

Default cParcela := "" // parcela a gerar

cChave := xFilial("SE1") + cSerieDev + cNumTroc

// Procura parcela a gerar
dbSelectArea("SE1")
dbSetOrder(1) // E1_FILIAL+E1_PREFIXO+E1_NUM+E1_PARCELA+E1_TIPO
dbSeek(cChave)
	
While !Eof();
	.And. cChave == SE1->(E1_FILIAL + E1_PREFIXO + E1_NUM)
...
// verifica tipo de documento de venda
If SL1->L1_IMPRIME == "1"
	cTipDoc := "CF "
Else
	cTipDoc := "NF "
...
//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Gera titulo no contas a receber ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
RecLock("SE1", .T.)
Replace E1_FILIAL	with xFilial("SE1")
Replace E1_PREFIXO	with "U" + cFilAnt
...
Replace E1_SALDO	with SE1->E1_VALOR
Replace E1_VENCTO	with dDataBase + 30
...
Replace E1_NUMNOTA	With cNumTroc
Replace E1_FILORIG	With cFilAnt
Replace E1_MULTNAT	With "2"
Replace E1_FLUXO	With "N"
Replace E1_HIST		With cTipDoc + SL1->L1_DOC + "/" + SL1->L1_SERIE
msUnlock()
...
ฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑฑ
ฑฑษออออออออออัออออออออออหอออออออัออออออออออออออออออออออออออหออออออัออออออออออปฑฑ
ฑฑบPrograma  ณ BaixaNCC บAutor  ณ Paulo Benedet            บ Data ณ 06/08/08 บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออออออออสออออออฯออออออออออนฑฑ
ฑฑบDescricao ณ Baixar a NCC da devolucao                                     บฑฑ
ฑฑฬออออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบParametrosณ cParcela - Parcela da NCC a ser baixada                       บฑฑ
ฑฑบ          ณ nValor   - Valor a ser baixado                                บฑฑ
ฑฑฬออออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบRetorno   ณ Nao ha                                                        บฑฑ
ฑฑฬออออออออออุอออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบAplicacao ณ Rotina executada pelo DxDevDin                                บฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
Static Function BaixaNCC(cParcela, nValor)
Local cCaixaNcc := SubStr(GetMv("MV_CXLOJA"),1,3) // banco
Local cAgenNcc  := SubStr(GetMv("MV_CXLOJA"),5,5) // agencia
Local cContaNcc := SubStr(GetMv("MV_CXLOJA"),11,20) // conta
Local aBaixa	:= {}

Private lmsErroAuto	:= .F. // variavel do execauto

//ฺฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฟ
//ณ Gera a baixa automatica ณ
//ภฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤฤู
AADD( aBaixa, { "E1_PREFIXO"	, "U" + cFilAnt					, Nil })
AADD( aBaixa, { "E1_NUM"     	, cNumTroc						, Nil })
AADD( aBaixa, { "E1_PARCELA" 	, cParcela						, Nil })
AADD( aBaixa, { "E1_TIPO"    	, "NCC"							, Nil })
AADD( aBaixa, { "E1_CLIENTE"	, cCliente						, Nil })
AADD( aBaixa, { "E1_LOJA"    	, cLoja							, Nil })
AADD( aBaixa, { "AUTMOTBX"  	, "NOR"							, Nil })
AADD( aBaixa, { "AUTBANCO"  	, cCaixaNcc						, Nil })
AADD( aBaixa, { "AUTAGENCIA"	, cAgenNcc						, Nil })
AADD( aBaixa, { "AUTCONTA"  	, cContaNcc						, Nil })
AADD( aBaixa, { "AUTDTBAIXA"	, dDataBase						, Nil })
AADD( aBaixa, { "AUTHIST"   	, "BAIXA AUTOMATICA DEVOLUCAO"	, Nil })
...
// altera o banco onde foi feita a baixa
dbSelectArea("SE5")
dbSetOrder(7) // E5_FILIAL+E5_PREFIXO+E5_NUMERO+E5_PARCELA+E5_TIPO+E5_CLIFOR+E5_LOJA+E5_SEQ
dbSeek(xFilial("SE5") + "U" + cFilAnt + cNumTroc + cParcela + "NCC" + cCliente + cLoja)

While !EOF();
	.And. SE5->E5_FILIAL  == xFilial("SE5");
	.And. SE5->E5_PREFIXO == "U" + cFilAnt;
	.And. SE5->E5_NUMERO  == cNumTroc;
	.And. SE5->E5_PARCELA == cParcela;
	.And. SE5->E5_TIPO    == "NCC";
	.And. SE5->E5_CLIFOR  == cCliente;
	.And. SE5->E5_LOJA    == cLoja
	
	If SE5->E5_VALOR == nValor;
		.And. SE5->E5_DATA == dDataBase;
