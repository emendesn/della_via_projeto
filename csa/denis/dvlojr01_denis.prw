#Include "Protheus.Ch"
/*
Obs.: Este programa foi baseado em outro desenvolvido pela fabrica de software
Microsiga. Do Original, somente as queries para pesquisa dos dados foram mantidas.
