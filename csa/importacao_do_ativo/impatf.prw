...
ฑฑบRotina    ณ IMPATF   บAutor  ณErnani Forastieri   บ Data ณ  10/10/03   บฑฑ
...
aAdd( _aDadCab, { "N1_CBASE"  ,	"C", 	   3, 	10, 0, .T.  } ) //	Cฅdigo Base do Bem
aAdd( _aDadCab, { "N1_ITEM"   ,	"C", 	  13, 	 4, 0, .T.  } ) //	Numero do Item
aAdd( _aDadCab, { "N1_AQUISIC", "D", 	  17, 	 8, 0, .T.  } ) //	Data de Aquisiฆงo
aAdd( _aDadCab, { "N1_DESCRIC", "C", 	  25, 	40, 0, .T.  } ) //	Descriฆงo Sint+tica
...
aAdd( _aDadCab, { "N1_APOLICE", "C", 	 117, 	15, 0, .T.  } ) //	Numero da Apฅlice
aAdd( _aDadCab, { "N1_DTVENC" ,	"D", 	 132, 	 8, 0, .T.  } ) //	Vencimento do Seguro
aAdd( _aDadCab, { "N1_TIPOSEG",	"C", 	 140, 	 5, 0, .T.  } ) //	Tipo de Seguro
aAdd( _aDadCab, { "N1_FORNEC" ,	"C", 	 145, 	 6, 0, .T.  } ) //	Cฅdigo do Fornecedor
...
aAdd( _aDadCab, { "N1_PROJETO", "C", 	 168, 	10, 0, .T.  } ) //	Cฅdigo do Projeto
...
aAdd( _aDadItens, { "N3_TXDEPR1", 	"N", 	 479, 	 8, 4, .T.  } ) //	Taxa Anual Depreciaฆงo 1
aAdd( _aDadItens, { "N3_VORIG2" , 	"N", 	 487, 	16, 4, .T.  } ) //	Valor Original Moeda 2
aAdd( _aDadItens, { "N3_TXDEPR2", 	"N", 	 503, 	 8, 4, .T.  } ) //	Taxa Anual Depreciaฆงo 2
aAdd( _aDadItens, { "N3_VORIG3" , 	"N", 	 511, 	16, 4, .T.  } ) //	Valor Original Moeda 3
aAdd( _aDadItens, { "N3_TXDEPR3", 	"N", 	 527, 	 8, 4, .T.  } ) //	Taxa Anual Depreciaฆงo 3
aAdd( _aDadItens, { "N3_VORIG4" , 	"N", 	 535, 	16, 4, .T.  } ) //	Valor Original Moeda 4
aAdd( _aDadItens, { "N3_TXDEPR4", 	"N", 	 551, 	 8, 4, .T.  } ) //	Taxa Anual Depreciaฆงo 4
aAdd( _aDadItens, { "N3_VORIG5" , 	"N", 	 559, 	16, 4, .T.  } ) //	Valor Original Moeda 5
aAdd( _aDadItens, { "N3_TXDEPR5", 	"N", 	 575, 	 8, 4, .T.  } ) //	Taxa Anual Depreciaฆงo 5
...
aAdd( _aDadItens, { "N3_INDICE1", 	"N", 	 871, 	 8, 4, .T.  } ) //	Indice de Depreciaฆงo 1
aAdd( _aDadItens, { "N3_INDICE2", 	"N", 	 879, 	 8, 4, .T.  } ) //	Indice de Depreciaฆงo 2
aAdd( _aDadItens, { "N3_INDICE3", 	"N", 	 887, 	 8, 4, .T.  } ) //	Indice de Depreciaฆงo 3
aAdd( _aDadItens, { "N3_INDICE4", 	"N", 	 895, 	 8, 4, .T.  } ) //	Indice de Depreciaฆงo 4
aAdd( _aDadItens, { "N3_INDICE5", 	"N", 	 903, 	 8, 4, .T.  } ) //	Indice de Depreciaฆงo 5
...
aAdd( _aDadItens, { "N3_IDBAIXA", 	"C", 	1265, 	 1, 0, .T.  } ) //	Identificacงo da Baixa
