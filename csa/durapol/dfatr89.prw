...
Static Function RunReport()
	...
	cSql := ""
	cSql := cSql + " SELECT D2_DOC,D2_SERIE,D2_ITEM,D2_CLIENTE,D2_LOJA,A1_NOME,D2_TES,D2_COD,B1_DESC,C2_NUM,C2_ITEM"
	cSql := cSql + " ,C2_SEQUEN,C2_PRODUTO,D2_PRUNIT,D2_QUANT,D2_TOTAL,D2_DESCON,C7_TOTAL,B1_X_GRUPO,B1_GRUPO,D2_EMISSAO,B1_X_DEPTO"
