...
{ OemToAnsi('Manutencao')   ,'U_DESTA01m'  , 0, 4 },;
...
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±
±±ÚÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÂÄÄÄÄÄÄÂÄÄÄÄÄÄÄÄÄÄ¿±±
±±³Fun‡„o    ³DESTA01m  ³ Autor ³ Golo                  ³ Data ³04.03.2005³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡„o ³ Manutencao - Producao                                      ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ´±±
±±³Parametros³ ExpC1 = Alias do arquivo                                   ³±±
...
±±ÀÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ±±
±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±±*/
User Function DESTA01m( cAlias, nReg, nOpcx )
...
Local aRegs   := {}
Local nIndex
AAdd(aRegs,{cPerg,"01","Data Autoclave ?"," "," ","mv_ch1","D", 8,0,0,"G","","mv_par01","","","","","","","","","","","","","","","","","","","","","","","","",""})
AAdd(aRegs,{cPerg,"02","Autoclave      ?"," "," ","mv_ch2","C", 2,0,0,"G","","mv_par02","","","","","","","","","","","","","","","","","","","","","","","","",""})
AAdd(aRegs,{cPerg,"03","Rodada         ?"," "," ","mv_ch3","C", 2,0,0,"G","","mv_par03","","","","","","","","","","","","","","","","","","","","","","","","",""})
...
cSql := "select C2_NUM    , C2_DATPRF , C2_PRODUTO, C2_QUANT  , C2_DATPRI , C2_OBS    , C2_EMISSAO, C2_TPOP, "
cSql += "       C2_SERIEPN, C2_PRODUTO, C2_NUMFOGO, C2_MARCAPN, C2_CARCACA, C2_X_DESEN, C2_UM "
cSql += "  from " + RetSqlName("SC2") + " SC2 " 
cSql += " where D_E_L_E_T_ = ' ' "
cSql += "   and C2_FILIAL  = '" + xfilial("SC2") + "' "
cSql += "   and C2_XDTCLAV = "  + MV_PAR01
cSql += "   and C2_XACLAVE = "  + MV_PAR02
cSql += "   and C2_XNUMROD = "  + MV_PAR03
...
/////////oEnch := MsMGet():New( cAlias, nReg,2,,,,aVisual,_aPos,aAltera, 3, , , , , ,.T., , , , ,aCampos )
oGetD := MSGetDados():New(aPosObj[ 2, 1 ], aPosObj[ 2, 2 ],aPosObj[ 2, 3 ]-40, aPosObj[ 2, 4 ]-23, 2, 'AllWaysTrue','AllWaysTrue',, .T. )
@aPosObj[ 2, 3 ]-35, aPosObj[ 2, 4 ]-180 BUTTON oProximo  PROMPT '&Proximo'  SIZE 42,12 PIXEL ACTION U_DESTA01p()
@aPosObj[ 2, 3 ]-35, aPosObj[ 2, 4 ]-130 BUTTON oLiberar  PROMPT '&Liberar'  SIZE 42,12 PIXEL ACTION U_DESTA01b()
@aPosObj[ 2, 3 ]-35, aPosObj[ 2, 4 ]-80  BUTTON oRejeitar PROMPT '&Rejeitar' SIZE 42,12 PIXEL ACTION U_DESTA01e()
ACTIVATE MSDIALOG oDlgEsp
...
User Function DESTA01p ( cAlias, nReg, nOpcx )
// Retorna para o loop
Return Nil
