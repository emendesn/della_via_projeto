...
cUserLog            := Upper(Trim(GetMV("MV_USERINS")))
...
{ "TR1_SERIED1", "C", TamSX3('C2_SERIED1')[1]  , 0                     } }
...
cQuery += " ,C2_NUMD1, C2_SERIED1, C2_ITEMD1 "
...
While (cAlias1)->( !Eof() )
	...
	TR1->TR1_SERIED1 := (cAlias1)->C2_SERIED1
...
cQuery += " FROM " + RetSqlName("SC2") + " SC2, " + RetSqlName("SD1") + " SD1 "
cQuery += " WHERE C2_FILIAL = '" + xFilial('SC2') + "' AND D1_FILIAL = '" + xFilial('SD1') + "' AND"
cQuery += " D1_DOC = '" + cNumOP + "' AND SUBSTRING(D1_ITEM,3,2) = '" + cItemOP + "' And D1_TIPO = 'B' AND"
cQuery += " D1_DOC = C2_NUM And SUBSTRING(D1_ITEM,3,2) = C2_ITEM AND"
cQuery += " SC2.D_E_L_E_T_ = ' ' AND"
cQuery += " SD1.D_E_L_E_T_ = ' '"
