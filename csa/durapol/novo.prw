...
±±ºPrograma  ³M460Proc  ºAutor  ³Microsiga           º Data ³  31/07/05   º±±
...
For nTitulo := 1 to Len(aTitulos)
	IF aTitulos[nTitulo][8] // Somente creditos marcados
		...
		// Baixa o titulo gerado para compensação
		DbSelectArea("SE1")
		DbSetOrder(1)
