...
±±ºPrograma  ³ MTA650I  º Autor ³ Jader              º Data ³  23/08/05   º±±
±±ÌÍÍÍÍÍÍÍÍÍÍØÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÍÊÍÍÍÍÍÍÏÍÍÍÍÍÍÍÍÍÍÍÍÍ¹±±
±±ºDesc.     ³ Ponto de entrada na confirmacao da inclusao da OP.         º±±
...
If SM0->M0_CODIGO == "03"   // So executa para Durapol
	...
	_cObs1 := M->C2_XOBS1
	MSMM(,80,,_cObs1,1,,,"SC2","C2_XCOBS1")

	_cObs2 := M->C2_XOBS2
	MSMM(,80,,_cObs2,1,,,"SC2","C2_XCOBS2")

	_cObs3 := M->C2_XOBS3
	MSMM(,80,,_cObs3,1,,,"SC2","C2_XCOBS3")
