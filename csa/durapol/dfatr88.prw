...
Static Function RunReport()
	...
	cSql := ""
	cSql := cSql + "SELECT D2_FILIAL,D2_EMISSAO,D2_TOTAL,D2_DESCON,D2_QUANT,D2_TES,D2_DOC,D2_SERIE"
	...
	Do While !eof()
		...
		For k=1 to nLoop
			...
			//Do While !eof() .AND. TMP->T_EMISSAO = ARQ_SQL->D2_EMISSAO
