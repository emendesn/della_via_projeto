...
Local _nPosTipo   := aScan(aHeader,{|x| Upper(alltrim(x[2])) == "D1_TIPO"})
...
IF FUNNAME() == "MATA103"
	IF _cCampo == 'D1_SERVICO' .and. cTipo == "B"
		...
		IF !Empty(SB1->B1_PRODUTO)
			...
			//	aCols[n][_nPosVTot]  := IF(A103Trigger("D1_TOTAL"),aCols[n][_nPosVTot],aCols[n][_nPosVTot])
