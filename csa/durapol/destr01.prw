...
ฑฑบPrograma  ณDESTR01   บ Autor ณ Reinaldo Caldas    บ Data ณ  15/04/05   บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Emissao de Ficha de Produ็ใo                               บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
SetRegua(RecCount())
	...
	dbSelectArea("SC6")
	dbSetOrder(1)
	dbSeek(xFilial("SC6")+SC2TMP->C2_PEDIDO+SC2TMP->C2_ITEMPV+SC2TMP->C2_PRODUTO)
	...
	@ nLin,010 PSAY SC6->C6_NFORI            //Coleta
	@ nLin,036 PSAY STOD(SC2TMP->C2_EMISSAO)         //Data Emissao
	@ nLin,045 PSAY chr(255)+ Chr(14)+ (SC2TMP->C2_NUM)+" "+(SC2TMP->C2_ITEM) //Numero da Ficha
	
	nLin:= nLin + 1
	
	@ nLin,010 PSAY SC2TMP->C2_PRODUTO           //Medida
	@ nLin,045 PSAY IIF(Empty(SC2TMP->C2_SERIEPN),SC2TMP->C2_NUMFOGO,SC2TMP->C2_SERIEPN) //Num.Serie/Numero Fogo
