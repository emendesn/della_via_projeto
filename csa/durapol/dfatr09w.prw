...
Private m_pag      	:= 01
Private imprime     := .T.
Private wnrel      	:= "DFATR09W"
Private _cPerg     	:= "DFAT09W"
...
IF nOrdem = 1
_cQry += " order by F2_VEND3, F2_CLIENTE "
ElseIF nOrdem = 2
_cQry += " order by F2_VEND4, F2_CLIENTE "
Else
_cQry += " order by F2_VEND5, F2_CLIENTE "
EndIF
