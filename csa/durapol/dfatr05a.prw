...
User Function DFATR05A()
	...
	Local nomeprog	:= "DFATR05a"
	Local cPerg   	:= "MT730a"
    Private wnrel	:= "DFATR05a" // Nome do Arquivo utilizado no Spool 
    ...
    Private Cabec1         := ""
	Private Cabec2         := ""
	Private wnrel          := "DFAT05A"
	Private lImp           := .F.

	cPerg    := PADR(cPerg,6)
	aRegs    := {}  

    aAdd(aRegs,{cPerg,"01","Numero do Pedido ?"," "," ","mv_ch1","C",06,0,0,"G","","mv_par01",""            ,"","","","","",""    ,"","","","",""             ,"","","","",""            ,"","","","","","","","SC5","","","","",""          })
    AADD(aRegs,{cPerg,"02","Status OP        ?"," "," ","mv_ch2","N",01,0,0,"C","","mv_par02","So Liberados","","","","","Todas"  ,"","","","",""             ,"","","","",""            ,"","","","","","","",""   ,"","","","",""          })
	AADD(aRegs,{cPerg,"03","Faturados        ?"," "," ","mv_ch3","N",01,0,0,"C","","mv_par03","Nao Imprime" ,"","","","","Todas"  ,"","","","",""             ,"","","","",""            ,"","","","","","","",""   ,"","","","",""          })
...
Static Function RunReport()
	...
	If mv_par03 = 1  // Não Imprime Faturado
	...
	cQuery += "   AND SC5.C5_NUM     = '" + mv_par01 + "' "
	...
	While !Eof()
		...
		if (mv_par02 = 1 .and. Arq_Sql->C2_X_Statu = "9") 
			dbSelectArea("Arq_Sql")
			dbskip()
			loop
		endif
