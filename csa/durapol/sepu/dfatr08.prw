...
OLE_SetDocumentVar(HandleWord, "C2_EMISSAO"    ,DTOC(SC2->C2_EMISSAO))  // data de emissao
...
OLE_SetDocumentVar(HandleWord, "C2_NUM"        ,SC2->C2_NUM)      // coleta exame
OLE_SetDocumentVar(HandleWord, "F1_EMISSAO"    ,SF1->F1_EMISSAO)  // data coleta exame
...
//OLE_SetDocumentVar(HandleWord, ""    ,SC2->)  // servico exame
OLE_SetDocumentVar(HandleWord, "C2_XPRCTAB"    ,SC2->C2_C2_XPRCTAB)  // preco tabela
...
_cStatus := If(SZS->ZS_TIPO=="A","APROVADO","REPROVADO")
