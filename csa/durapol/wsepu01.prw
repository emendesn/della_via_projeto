...
ฑฑฬออออออออออุออออออออออออออออออออออออออออออออออออออออออออออออออออออออออออนฑฑ
ฑฑบAlteracoesณ Este programa foi alterado e seu processo foi revisto      บฑฑ
ฑฑบ14/12/05  ณ devido a erros de reclamados pela Dellavia. Felipe 14/12/05บฑฑ
ฑฑบAlteracoesณ Foi alterada a ordem de envio dos e-mails (a ordem nova eh บฑฑ
ฑฑบ19/12/05  ณ Producao -> Comercial -> Diretoria) sem envios de mensagensบฑฑ
ฑฑบpor Felipeณ simultaneas que estavam confundindo os usuarios. Tb foram  บฑฑ
ฑฑบ          ณ incluidos campos que valor calculado e valor sugerido      บฑฑ
ฑฑบ          ณ para facilitar a leitura/interpretacao do e-mail pelo usua-บฑฑ
ฑฑบ          ณ rio.														  บฑฑ
ฑฑบAlteracoesณ Foi alterada a forma de notificacao de SEPU aprovada para  บฑฑ
ฑฑบ19/12/05  ณ usar o objeto padrao de workflow.                          บฑฑ
ฑฑบpor Felipeณ                                                            บฑฑ  
ฑฑบAlterado em 10/03/06 para compatibiliza็ao a serie 2 da coleta         บฑฑ  
...
ChkFile('SF1') // tabela de cabe็alho de notas fiscais entrada
