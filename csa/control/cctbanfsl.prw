...
/*/
User Function CCTBANFSL(aPergunte)
...
If	nOpcA == 1
	Do Case
		Case IsBlind() .And. !lAuto
			...
			" "+ Chr(13) + Chr(10) +;
			" ", "CTBNFS",;
			{ || 	U_CMaCtbNfs(MV_PAR01==1,MV_PAR02==1,MV_PAR03,;
			MV_PAR04==1,MV_PAR05,MV_PAR06,MV_PAR07,MV_PAR08,If(cPaisLoc=="BRA",.F.,MV_PAR09==1),;
			Nil,.F.) }, { || .F. })
		Case !lAuto
			oRegua := MsNewProcess():New({|lEnd| U_CMaCtbNfs(MV_PAR01==1,;
			MV_PAR02==1,;
			MV_PAR03,;
			MV_PAR04==1,;
			MV_PAR05,;
...
ъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъъ
/*/
User Function CMaCtbNfs(lDigita,lAglutina,nTpCtb,lCMV,dDataIni,dDataFim,cFilDe,cFilAte,lContNCP,oObj,lEnd)
	...
	For nY := 1 To 2
		...
		#IFDEF TOP
			If TcSrvType()<>"AS/400"
				...
				aOptimize[OPT_WHERE] += "SD2.D2_ORIGLAN<>'LF' AND SD2.D2.ORIGLAN='LO' AND  "
...
If cPaisLoc <> "BRA" .and. SF2->(FieldPos("F2_DTDIGIT"))>0 
     ...
     Else
			If lContNCP
				U_CCTBANCPS(lDigita,lAglutina,nTpCtb,lCMV,dDataIni,dDataFim,cFilDe,cFilAte,oObj,lEnd)
				RestArea(aAreaSM0)
				RestArea(aArea)
				cFilAnt := SM0->M0_CODFIL
				dDataBase := dSavBase
...
User Function cCTBANCPS(lDigita,lAglutina,nTpCtb,lCMV,dDataIni,dDataFim,cFilDe,cFilAte,oObj,lEnd)
