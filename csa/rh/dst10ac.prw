...
User Function DST10AC (cColeta)
	...
	Private cDesc3         	:= ""
	Private tamanho        	:= "G"
	Private nomeprog       	:= "DST10AC"
	Private lAbortPrint    	:= .F.
	Private nTipo          	:= 15
	Private aReturn        	:= { "Zebrado", 1, "Administracao", 1, 1, 1, "", 1}
	Private nLastKey       	:= 0
	Private cPerg          	:= "DST10AC"
	Private titulo         	:= "Consulta Recapagens"
	Private Li             	:= 80
	Private Cabec1         	:= ""
	Private Cabec2         	:= ""
	Private m_pag          	:= 01
	Private wnrel          	:= "DST10AC"
	Private lImp           	:= .F.
	Private Cab1           	:= ""
	Private Cab2           	:= ""
   	Private Cab3           	:= ""   
...
Static Function RunF1C2 (cColeta)
