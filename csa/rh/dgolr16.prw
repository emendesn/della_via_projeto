...
*/
	...
	Private cDesc3         := " "
	Private tamanho        := "G"
	Private nomeprog       := "DGOLR16"
	Private lAbortPrint    := .F.
	Private nTipo          := 15
	Private aReturn        := { "Zebrado", 1, "Administracao", 1, 1, 1, "", 1}
	Private nLastKey       := 0
	Private cPerg          := "DGOL16"
	Private titulo         := "Pesquisa PNEUS GRUPO:OOO1 SB9-SD2 Agrupamento por Lojas"
	Private Li             := 99
	Private Cabec1         := ""
	Private Cabec2         := ""
	Private m_pag          := 01
	Private wnrel          := "DGOLR16"
	Private lImp           := .F.
 	Private Cab1           := ""
 	Private Cab2           := ""
  	Private Cab3           := ""   
	...
	cPerg    := PADR(cPerg,6)
	aRegs    := {}  
	aAdd(aRegs,{cPerg,"01","Grupo........0001?"," "," ","mv_ch1","C",04,0,0,"G","","mv_par01","","","","","","","","","","","","","","","","","","","","","","","","","SBM","","","",""          })
   	aAdd(aRegs,{cPerg,"02","Grupo........0001?"," "," ","mv_ch2","C",04,0,0,"G","","mv_par02","","","","","","","","","","","","","","","","","","","","","","","","","SBM","","","",""          })
   	...
   	aAdd(aRegs,{cPerg,"05","                  "," "," ","mv_ch5","C",50,0,0,"G","","mv_par05","","","","","","","","","","","","","","","","","","","","","","","","","SF4","","","",""          })
   	...
   	aAdd(aRegs,{cPerg,"11","Data Saldo.......?"," "," ","mv_ch9","D",08,0,0,"G","","mv_par11","","","","","","","","","","","","","","","","","","","","","","","","","   ","","","",""          })
   	aAdd(aRegs,{cPerg,"12","Produto..........?"," "," ","mv_chA","C",06,0,0,"G","","mv_par12","","","","","","","","","","","","","","","","","","","","","","","","","SB1","","","",""          })
   	aAdd(aRegs,{cPerg,"13","Tipo Relat....A/S?"," "," ","mv_chB","C",01,0,0,"G","","mv_par13","","","","","","","","","","","","","","","","","","","","","","","","","   ","","","",""          })
...
Static Function RunReport()
    ...
    if upper(mv_par14) = "S"    // Excel = "S"
		mv_par01:= "0001"
		mv_par02:= "0001"
  		Cabec1 	:= "]FL]Codigo]LA]Descricao do Produto..........]Grup]  Data  ]Sd Est An]    Vl Est An]  Cons An]  Custo Medio]  Vlr NFiscal]MBruta]DEst]Sd Est At]    Vl Est At]  Cons At]  Custo Medio]  Vlr NFiscal]MBruta]DEst]" 
