...
±±³Fun‡…o    ³ GPER012  ³ Autor ³ R.H. - Reginaldo      ³ Data ³ 24.09.02 ³±±
±±ÃÄÄÄÄÄÄÄÄÄÄÅÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÁÄÄÄÄÄÄÁÄÄÄÄÄÄÄÄÄÄ´±±
±±³Descri‡…o ³ Funcionarios Demitidos                                     ³±±
...
Private NomeProg:= "GPER004"
Private aLinha  := { },nLastKey := 0
Private cPerg   := "GPER04"
...
cTit   := " Funcionarios Demitidos "

//ÚÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄ¿
//³ Envia controle para a funcao SETPRINT                        ³
//ÀÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÄÙ
wnrel:="GPER004"            //Nome Default do relatorio em Disco
...
cFilAte    := mv_par04
cCategoria := mv_par05
wCabec1  := "Fl C.C.   Matric. Nome                                Dt Admissao  Dt Demissao  Funcao                                   Salario"
Titulo   := " Relacao de Funcionarios Demitidos de " + Dtoc(dDatade) + " a " + Dtoc(dDataAte)
...
cQuery_ := "SELECT RA_FILIAL,RA_MAT,RA_NOME,RA_CC,RA_CATFUNC,RA_ADMISSA,RA_DEMISSA,RA_SALARIO,RA_NUMCP,RA_SERCP,RJ_DESCCMP " "
...
cQuery_ += " AND RA_DEMISSA >= '" + Dtos(dDataDe) + "' AND RA_DEMISSA <='"+ DTOS(dDataAte)+"'"
cQuery_ += " AND RA_AFASFGT <> 'N' " 
...
While	!EOF()
    ...
    cDet +=  TRansform(STOD(SRANEW->RA_ADMISSA),"@R 99/99/9999") + "   " +TRansform(STOD(SRANEW->RA_DEMISSA),"@R 99/99/9999") + "   " + substr(SRANEW->RJ_DESCCMP,1,40) + "  " + TRansform(SRANEW->RA_SALARIO,"@E 99,999.99") 
    Impr(cDet)
