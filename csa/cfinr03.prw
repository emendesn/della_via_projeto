...
ฑฑบPrograma  ณCFinr03   บ Autor ณ Fabio Henrique บ      Data ณ  09/08/05  บฑฑ
ฑฑฬออออออออออุออออออออออสอออออออฯออออออออออออออออออออสออออออฯอออออออออออออนฑฑ
ฑฑบDescricao ณ Relat๓rio de Tํtulos a Receber por Emissใo                 บฑฑ
ฑฑบ          ณ                                                            บฑฑ
...
Local cDesc3         := "Titulos por Emissใo Durapol"
Local cPict          := ""
Local titulo         := "Titulos por Emissใo"
Local nLin           := 60
Local cPerg          := "FINR03"
Local Cabec1         := "Este programa ira imprimir dados dos tํtulos conforme"
...
While !Eof()                                                           
	...
	// Looping necessแrio para a mudan็a de filial (nFilial
	dbSelectArea("SE1")
	dbSetOrder(6)
	dbSeek(nFilial+ DTOS(mv_par01),.T.)
	...
	While !Eof() .and. E1_EMISSAO <= mv_par02 
		...
		If nLin > 55  	
		 	 ...
		 	 nLin := nLin + 2
		 	 @ nLin,070 PSAY	"Rela็ใo de Tํtulos por Emissใo"
	         nLin := nLin + 1 
		...
		If E1_BAIXA == CTOD(' ')
		    ...
		    // CASO NรO EXISTA ENDEREวO DE COBRANวA CADASTRADO SELECIONA ENDEREวO PADRรO
