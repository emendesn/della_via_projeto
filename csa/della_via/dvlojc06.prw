...
User Function DVLOJC06(cVarCli,cVarLoja)
	Local   aArea   := GetArea()
	Local   cNomTmp := ""
	Local   cSql    := ""
	Local   aEstru  := {}
	...
	*/
	...
	cSql += " ,     E1_VENCREA,E1_VALOR,E1_SALDO,E1_PORTADO,E1_NUMBCO,X5_DESCRI"
	...
	Do While !eof()
		...
		If RecLock("TMP",.T.)
			...
			If E1_VENCREA < dDataBase
				...
				DIAS := dDataBase - E1_VENCREA
			Elseif E1_SALDO < E1_VALOR
				XX_BITMAP := "BR_AMARELO"
				DIAS := iif((dDataBase - E1_VENCREA)>0,dDataBase - E1_VENCREA,0)
			Else
				XX_BITMAP := "BR_VERDE"
			Endif
			MsUnlock()
	...
	aadd(aHeader,{"Saldo"      ,"E1_SALDO"  ,"@e 99,999,999,999.99",14     ,2      ,""       ,         ,"N"})
	...
	@ 000,000 TO 450,640 DIALOG oDlg1 TITLE "Titulos em aberto"
	...
	@ 145,020 SAY "Sem baixas" Object oLeg01 Pixel

	@ 155,010 BITMAP oBmp RESNAME "BR_AMARELO" SIZE 7,7 NOBORDER OF oDlg1 PIXEL
	@ 155,020 SAY "Baixado parcial" Object oLeg02 Pixel

	@ 165,010 BITMAP oBmp RESNAME "BR_VERMELHO" SIZE 7,7 NOBORDER OF oDlg1 PIXEL
	@ 165,020 SAY "Em atraso" Object oLeg03 Pixel
	...
	@ 165,200 SAY "Saldo Titulos:" Object oLblTotSld Font oFontBold Pixel
	@ 165,250 SAY "R$  "+AllTrim(Transform(nTotSld,"@e 99,999,999,999.99")) Pixel Size 50,12 Right

	@ 175,200 SAY "Total em atraso:" Object oLblTotAtr Font oFontBold Pixel
	@ 175,250 SAY "R$  "+AllTrim(Transform(nTotAtr,"@e 99,999,999,999.99")) Pixel Size 50,12 Right

	@ 185,200 SAY "Total de NCC:" Object oLblTotAtr Font oFontBold Pixel
	@ 185,250 SAY "R$  "+AllTrim(Transform(nTotNCC,"@e 99,999,999,999.99")) Pixel Size 50,12 Right
...
Static Function Visual
	Local aArea := GetArea()
	Private cCadastro := "Consulta Titulos em aberto"
