...
aAdd( aHead , { "cObsPed"   , "C",  81,  80,  0, "Left(TSC7->C7_OBS,80)"  } )
...
#IFDEF TOP
	cQuery := ""
	cQuery += " SELECT C7_FLAGPIR,C7_FILIAL,C7_NUM,C7_ITEM,C7_PRODUTO,C7_QUANT,C7_EMISSAO, C7_OBS, R_E_C_N_O_ AS SC7RECNO FROM " + RetSqlName( "SC7" )
...
While ! TSC7->( Eof() )
	...
	// Inclusao da Filial no nome do arquivo
	cArqTXT := SubStr(cArqTXT,1,_nTamOri)+TSC7->C7_FILIAL+"_"+TSC7->C7_NUM + ".TXT"
    ...
    //cPedAnt := TSC7->C7_NUM - Denis
    cPedAnt := TSC7->C7_FILIAL+TSC7->C7_NUM
	
	//While ! TSC7->( Eof() ) .and. cPedAnt == TSC7->C7_NUM - Denis
	While ! TSC7->( Eof() ) .and. cPedAnt == TSC7->C7_FILIAL+TSC7->C7_NUM
