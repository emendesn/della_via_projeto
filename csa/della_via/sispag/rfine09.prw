...
ฑฑบPrograma  ณRFINE09   บAutor  ณClaudio D. de Souza บ Data ณ  14/12/01   บฑฑ
...
฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿฿
*/
User Function RFINE09(cCodBar)
Local lRet := .T.,;
		nX			  ,;
		cCampo     ,;
		nRet := 0

cCodBar := Alltrim(M->E2_CODBAR)
...
OtherWise // Validacao da linha digitavel de concessionarias
	...
	For nX := 1 To Len(cCodSemDv) Step 11
		...
		If Mod10(cCampo) != SubStr(cCodBar,nX+ccont,1)
			lRet := .F.
			help(" ",1,"INVALCODBAR")
//			Exit
		Endif
