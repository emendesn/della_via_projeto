...
PutSx1(cPerg,"07","Da Regional               ?","","","mv_ch7" ,"C",02,0,0,"G","",""   ,"","","MV_PAR07"   ,"","","",""   ,"" ,"","",""          ,"","","","","","","PB0A","")  
PutSx1(cPerg,"08","Ate a Regional            ?","","","mv_ch8" ,"C",02,0,0,"G","",""   ,"","","MV_PAR08"   ,"","","",""   ,"" ,"","",""          ,"","","","","","","PB0A","")  
...
Local cGrupo		:= ""          
Local cCateg		:= ""          
Local Cabec1		:= "Regional " + mv_par07 + " a " + mv_par08 + " - Grupo " + mv_par10 + " a " + mv_par11 + " - Categoria " + mv_par12 + " a " + mv_par13
...
//		Aadd(aDadosDoa,{ "D" , TRB->UA_EMISSAO , TRB->UA_DOC , TRB->UA_SERIE , TRB->UA_FILIAL , TRB->LJ_NOME , TRB->UA_CLIENTE , TRB->UA_LOJA , TRB->A1_NOME , TRB->UA_VALBRUT , TRB->UA_VEND , Substr(TRB->A3_NOME,1,30), TRB->UA_NUM , TRB->UA_CODCON, cGRUPO , cCATEG })
        ...
        If Found()
           If mv_par07 <> "  "
              If PB0->PB0_REGION < mv_par07
                 lRegiao := .F.
              EndIf
           EndIf   
           If PB0->PB0_REGION > mv_par08
              lRegiao := .F.
           EndIf
        Else
           lRegiao := .F.
