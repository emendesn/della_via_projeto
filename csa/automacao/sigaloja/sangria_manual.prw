...
U_AutoSang(cBanco,cAgencia,cConta,cNumDoc,cHistorico,cTipo,nValor,dData_Ent)

MsgInfo("   Transferencia Efetuada !!   ","Mensagem")
oDlg:End()
Return

User Function AutoSang(cBanco,cAgencia,cConta,cNumDoc,cHistorico,cTipo,nValor,dDataEnt)
local cBancoOri
local cAgenciaOri
local cContaOri
