...
ฑฑบPrograma  ณDFinr03   บ Autor ณ Fabio Henrique บ      Data ณ  09/09/05  บฑฑ
...
Local cDesc3         := "Emissao de duplicatas Della Via"
Local cPict          := ""
...
SetRegua(RecCount())
	...
	While !Eof().and. xFilial("SE1") == SE1->E1_FILIAL .and. SE1->E1_NUM >= mv_par01 .and. SE1->E1_NUM <= mv_par02 .And.;
		SE1->E1_PREFIXO == mv_par03 .AND. SE1->E1_PARCELA >= mv_par04 .AND. SE1->E1_PARCELA <= mv_par05
	 	...
	 	If lAbortPrint
  		...
  		Endif
			...
			nLin:= nLin + 1		 
			@ nLin,007 PSAY ("|")	
			@ nLin,086 PSAY ("| INSCRICAO NO C.C.M. :                           |")		
			nLin:= nLin + 1		 
					@ nLin,007 PSAY ("|")
			...
			@ nLin,032 PSAY SE1->E1_VALOR Picture"@E@Z 999,999.99" + "     |"
			@ nLin,058 PSAY SE1->E1_NUM
			@ nLin,073 PSAY SE1->E1_PARCELA
			@ nLin,083 PSAY SE1->E1_VALOR Picture"@E@Z 999,999.99"
			...
			nLin := nLin + 1 	 
			@ nLin,007 PSAY ("|")		
			@ nLin,065 PSAY "| PAGAVEL A DELLA VIA PNEUS LTDA            "
			@ nLin,136 PSAY ("|")
			nLin := nLin + 1                                                 
			@ nLin,007 PSAY ("|")
